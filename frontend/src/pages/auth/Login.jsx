...
// Premium Login page using ONE form object
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <p className="text-center text-sm text-gray-500">
            Don’t have an account? <Link to={`/signup`} href="#" className="text-indigo-600 hover:underline">Sign up</Link>
          </p>
        </form>

        <div className="p-4 text-xs text-gray-400 text-center border-t border-gray-100">By continuing you agree to our Terms & Privacy</div>
      </div>
    </div>
  );
}